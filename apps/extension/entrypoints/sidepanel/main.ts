 ...
 * 创建并挂载 Side Panel Vue 应用，同时安装 YK-PETS 品牌、运行偏好、宠物工坊、记忆导入和当前页面筛选兼容层。
 * Creates and mounts the Side Panel Vue application and installs YK-PETS branding, runtime preferences, Pet Studio, memory import, and Current Page filter bridges.
 */
