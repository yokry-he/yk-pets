 ...
 * WXT 构建配置与 Chrome Manifest V3 权限、Side Panel、压缩包名称和 CSP 声明。
 * WXT build configuration and Chrome Manifest V3 permissions, Side Panel, ZIP naming, and CSP declarations.
 */
