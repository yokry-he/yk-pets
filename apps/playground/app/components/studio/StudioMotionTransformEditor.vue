...
<template>
  <section class="transform-editor">
    <header class="section-header">
      <div><small>DIRECT AUTHORING</small><h3>身体部件与变换</h3></div>
    ...
    <div class="part-tree" aria-label="动作身体部件树">
      ...
      ><span>{{ part.icon }}</span><strong>{{ part.labelZh }}</strong><small>{{ part.labelEn }}</small></button>
    </div>
    ...
    <div class="selection-line">
      <div><strong>{{ selectedPart.labelZh }}</strong><small>{{ selectedPart.labelEn }}</small></div>
...
<style scoped>
.transform-editor{display:grid;gap:9px;padding:10px;border:1px solid #52e0d022;border-radius:12px;background:linear-gradient(145deg,#52e0d008,#7066ff08)}.section-header{display:flex;align-items:center;justify-content:space-between;gap:8px}.section-header>div{display:grid;gap:3px}.section-header small{color:#727d9c;font:800 8px/1 ui-monospace,monospace;letter-spacing:.14em}.section-header h3{margin:0;font-size:13px}.key-button,.scope-tabs button,.mode-tabs button,.control-row button,.part-tree button{border:1px solid #ffffff1c;color:#dfe5ff;background:#090e1b;cursor:pointer}.key-button{min-height:30px;padding:0 8px;border-radius:8px;border-color:#52e0d055}.scope-tabs{display:grid;grid-template-columns:repeat(3,1fr);gap:4px}.scope-tabs button,.mode-tabs button{min-height:31px;border-radius:7px;font-size:9px}.scope-tabs button.active,.mode-tabs button.active{border-color:#52e0d077;background:#52e0d018;color:#d7fff9}.scope-tabs button:disabled,.mode-tabs button:disabled,.control-row button:disabled{cursor:not-allowed;opacity:.3}.scope-hint,.footer-hint{margin:0;color:#77829f;font-size:8px;line-height:1.45}.warning{margin:0;padding:7px;border:1px solid #ffcb6b44;border-radius:8px;color:#ffcf79;background:#ffcb6b0b;font-size:8px}.part-tree{display:grid;max-height:220px;overflow:auto;padding:4px;border:1px solid #ffffff12;border-radius:10px;background:#080c16}.part-tree button{display:grid;grid-template-columns:18px auto 1fr;align-items:center;gap:5px;min-height:29px;padding:0 7px 0 calc(7px + var(--depth) * 13px);border:0;border-radius:6px;text-align:left}.part-tree button:hover{background:#ffffff08}.part-tree button.active{color:#d6fff9;background:#52e0d018;box-shadow:inset 2px 0 #52e0d0}.part-tree span{color:#7fe7dc;text-align:center}.part-tree strong{font-size:9px}.part-tree small{overflow:hidden;color:#66718e;font-size:7px;text-overflow:ellipsis;white-space:nowrap}.mode-tabs{display:grid;grid-template-columns:repeat(4,1fr);gap:4px}.mode-tabs button{display:flex;align-items:center;justify-content:center;gap:4px}.mode-tabs kbd{display:grid;place-items:center;min-width:17px;height:17px;border:1px solid #ffffff22;border-radius:4px;color:#8e98b6;background:#ffffff08;font:700 8px/1 ui-monospace,monospace}.selection-line{display:flex;align-items:center;justify-content:space-between;gap:8px;padding:7px 1px}.selection-line>div{display:grid;gap:2px}.selection-line strong{font-size:10px}.selection-line small{color:#6d7896;font-size:8px}.selection-line label,.authoring-toggles label{display:flex;align-items:center;gap:5px;color:#aeb7d0;font-size:8px}.control-list{display:grid;gap:5px}.control-row{display:grid;grid-template-columns:minmax(88px,1fr) 28px minmax(82px,104px) 28px 28px;align-items:center;gap:4px;padding:5px;border:1px solid #ffffff12;border-radius:9px;background:#090d17}.control-row.selected{border-color:#7066ff66;background:#7066ff0c}.control-label{display:grid;gap:2px;min-width:0}.control-label strong{overflow:hidden;font-size:8px;text-overflow:ellipsis;white-space:nowrap}.control-label small{color:#66718f;font-size:7px}.control-row button{width:28px;height:28px;padding:0;border-radius:7px}.control-row .reset{color:#8590ae}.value-field{position:relative}.value-field input{box-sizing:border-box;width:100%;height:29px;padding:0 18px 0 6px;border:1px solid #ffffff1c;border-radius:7px;color:#fff;background:#060a13;font:700 9px/1 ui-monospace,monospace}.value-field span{position:absolute;right:6px;top:7px;color:#697491;font-size:8px}.authoring-toggles{display:grid;grid-template-columns:1fr 1fr;gap:5px;padding-top:4px;border-top:1px solid #ffffff12}.empty{margin:0;padding:9px;border:1px dashed #ffffff1b;border-radius:8px;color:#77829f;font-size:8px;line-height:1.45}@media(max-width:1180px){.part-tree{grid-template-columns:repeat(2,minmax(0,1fr));max-height:none}.part-tree button{padding-left:7px}.control-row{grid-template-columns:minmax(120px,1fr) 30px 110px 30px 30px}}
</style>
