...
const requiredDocuments = [
  ...
  'VALIDATION.zh-CN.md',
  'VALIDATION.en.md',
  ...['DESIGN', 'ARCHITECTURE', 'DEVELOPMENT', 'LOCAL-AGENT-PROTOCOL', 'SECURITY', 'ROADMAP', 'CURRENT-STAGE-GOALS', 'ACTIVE-BUG-BACKLOG', 'NEBULA-RADIAL-MENU', 'TAIL-DESIGN', 'MOTION-CONTROLS', 'USER-GUIDE', 'NETWORK-LAB-OPERATIONS', 'BUILD-AND-RELEASE', 'TROUBLESHOOTING', 'DEVELOPER-MAINTENANCE', 'CODE-COMMENT-STANDARD', 'NETWORK-LAB-v0.5.0', 'MOCK-WORKBENCH-HIGH-ENERGY-v0.5.1', 'DOCUMENTATION-AND-COMMENTS-v0.5.2', 'PET-VITALITY-FIREWORKS-v0.6.0', 'MOTION-FEEDBACK-v0.6.3', 'RULE-PROXY-FIX-v0.6.4', 'FETCH-MOCK-INTERCEPTION-v0.6.5', 'WHOLE-JSON-RESPONSE-v0.6.6', 'AUDIT-NETWORK-PET-FEEDBACK-v0.6.7', 'AUDIT-PET-AUDIO-v0.6.8', 'MOTION-VOICE-AUDIO-v0.6.9', 'PET-VOICE-PRESETS-v0.6.10'].flatMap(name => [
    `docs/zh-CN/${name}.md`,
    `docs/en/${name}.md`,
  ]),
