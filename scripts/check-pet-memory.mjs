 ...
 * 防止宠物记忆的本地存储、快捷捕捉、Side Panel 工作区和宠物反馈链路回退。
 * Prevents regressions in pet-memory local storage, quick capture, Side Panel workspace, and pet feedback flows.
 */
...
const checks = [
  ...
  ['runtime protocol covers memory CRUD and draft focus', messages.includes("type: 'YK_PET_MEMORY_CREATE'") && messages.includes("type: 'YK_PET_MEMORY_UPDATE'") && messages.includes("type: 'YK_PET_MEMORY_DRAFT_READY'")],
