...
const checks = [
  ...
  ['shared asset store owns stable motion and prop IDs', assets.includes("createStudioAssetId('motion')") && assets.includes("createStudioAssetId('prop')") && assets.includes('durationMs') && assets.includes('defaultAnchor') && assets.includes('propIds') && assets.includes('normalizeStudioAssetHydration') && domain.includes('normalizePropAssetCollection')],
  ...
  ['asset library links appearance motions props and built-in templates', libraryPage.includes("layout: 'studio'") && libraryPage.includes('BUILT_IN_STUDIO_MOTIONS.length') && libraryPage.includes('BUILT_IN_STUDIO_PROPS.length') && libraryPage.includes('copyBuiltInMotion') && libraryPage.includes('copyBuiltInProp') && libraryPage.includes('editMotion') && libraryPage.includes('editProp')],
