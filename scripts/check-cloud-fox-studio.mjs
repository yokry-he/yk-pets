...
const files = {
  ...
  propMotion: read('apps/playground/app/domain/cloud-fox-prop-motion.ts'),
...
const checks = [
  ...
  [8, 'local patch isolation test', files.patchTest.includes('nonTailSnapshot') && files.patchTest.includes('nonEarSnapshot') && files.patchTest.includes('nonBellySnapshot') && files.patchTest.includes('migratedLegacy') && files.package.includes('test:pet-studio-local-patches')],
