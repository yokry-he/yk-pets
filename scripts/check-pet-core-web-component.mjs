...
const checks = [
  ...
  ['AvatarCanvas detects missing inner canvas and uses the formal renderer fallback', avatarHost.includes("querySelector('canvas')") && avatarHost.includes('fallbackActive') && avatarHost.includes('ProductionAvatarCanvas') && avatarHost.includes('yk-pet-error')],
