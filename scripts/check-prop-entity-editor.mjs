...
const checks = [
  ...
  ['legacy props migrate into normalized entities', domain.includes('legacy-prop-migrated') && domain.includes('anchorIds') && workspace.includes('normalizePropAssetCollection') && store.includes('normalizeStudioAssetHydration') && workspace.includes('StudioPropAssetV2')],
