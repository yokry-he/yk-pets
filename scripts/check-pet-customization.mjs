 ...
 * 防止鼻嘴、肚皮、颜色、扩展范围、Studio 原生搜索/对比/聚焦、稳定布局、方案库和事务历史回退。
 * Prevents regressions in face parts, belly, colors, ranges, native Studio search/comparison/focus, stable layout, schemes, and transactional history.
 */
