...
const checks = [
  ...
  ['approved front and classic hind paw defaults remain', defaults.includes('embedDepth: .25') && defaults.includes('lateralOffset: .28, shoulderScale: 1.62') && body.includes('classicPawX') && customization.includes('createDefaultHindPawDesign') && hindEditor.includes('恢复经典后爪')],
