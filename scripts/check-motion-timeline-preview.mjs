...
const checks = [
  ...
  ['motion page evaluates once and passes one immutable pose to preview', page.includes('computed(() => draft.value ? evaluateNormalizedMotionAsset') && page.includes(':custom-pose="evaluatedPose"')],
