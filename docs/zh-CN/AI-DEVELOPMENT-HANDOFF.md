...
下一阶段是 `prop-studio-entity-editing`：

1. 定义版本化道具实体、参数化组件、材质和锚点变换；
2. 实现组件树、添加/复制/删除和局部变换编辑；
3. 实现颜色、透明度、金属度、粗糙度和发光；
4. 实现 `origin`、`grip`、`display`、`emitter` 数值操纵；
5. 在相同预览场景中渲染真实道具定义；
6. 完成复制、JSON 导入导出和资源预算。
