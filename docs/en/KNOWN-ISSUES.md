...
- Status: Implemented; browser recheck required.
- Complete: a 72% default preview fit, a +0.32 default vertical offset, 40%–120% toolbar scaling, three-axis free rotation, canvas drag rotation, and one-click reset; canvas wheel scaling is currently paused.
